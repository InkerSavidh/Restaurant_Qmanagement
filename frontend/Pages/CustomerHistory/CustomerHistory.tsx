    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 items-end">
          ...
          <div className="flex gap-2 sm:col-span-2 lg:col-span-1"><button onClick={handleApplyFilter} className="bg-[#0d6efd] text-white px-4 py-2 rounded text-xs sm:text-sm font-medium hover:bg-blue-600 flex-1">Apply Filter</button><button onClick={handleClearFilter} className="bg-gray-500 text-white px-4 py-2 rounded text-xs sm:text-sm font-medium hover:bg-gray-600 flex-1">Clear</button></div>
        </div>
      </div>
